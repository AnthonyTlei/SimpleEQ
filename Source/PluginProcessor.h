...
/*
    Created a data structure to hold our settings from the apvts
*/
...
#pragma region Aliases For Nested Namespaces
...
private:
    ...
    //Creating 2 Mono Channels, to process Stereo Audio
